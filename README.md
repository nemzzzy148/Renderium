...
`Renderium` is extremely similar to the WebGPU standard making it effortless for WebGPU users or for people beginning with graphics.

> ### Supported backend graphics API
> * Vulkan
